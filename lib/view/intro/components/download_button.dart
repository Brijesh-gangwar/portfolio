import 'package:brijesh_portfolio/secrets.dart';
...
class DownloadButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        launchUrl(Uri.parse(Secrets.resumeUrl));
      },
      child: Container(
...
//   static const _resumeUrl = 'https://portfolio-28d2jriv1-brijesh-gangwars-projects.vercel.app//resume.pdf';
